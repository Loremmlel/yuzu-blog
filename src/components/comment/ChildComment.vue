      ...
      <div class="parent-container" :key="child.id">
        ...
        <div class="comment-content">
          <div class="comment-content-header">
            ...
            <div>
              <SvgIcon @click="likeFun(child)" v-show="!child.isLike" name="like" style="cursor: pointer"></SvgIcon>
              <SvgIcon @click="cancelLikeFun(child)" v-show="child.isLike" name="like-selected"
                       style="cursor: pointer"></SvgIcon>
              <span style="font-size: 0.8em;color: grey">{{ child.likeCount }}</span>
              <SvgIcon @click="replyFun(comment.childComment, child.id)" name="comment"
